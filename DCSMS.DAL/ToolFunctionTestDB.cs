...
namespace DCSMS.DAL
{
    ...
    {
        public int toolFunctionTestCreate(List<int> toolFunctionTestStatus, List<String> toolFunctionTestComment, String orderId)
        {
            String sqlCommand = "insert into toolfunctiontest values (@OrderId, @Item1, @Item2, @Item3, @Item4, @Item5, @Item6, @Comment1, @Comment2, @Comment3, @Comment4, @Comment5, @Comment6)";
