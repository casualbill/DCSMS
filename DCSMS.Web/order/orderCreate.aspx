...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div class="main-content">
        <div class="content-list"><ul>
            ...
            <asp:HiddenField ID="hf_customerid" Value="" runat="server" /></li>

            <li><label>客户名称：</label><asp:TextBox ID="tb_customername" runat="server" MaxLength="100" Enabled="false"></asp:TextBox></li>
            <li><label>终客户名称：</label><asp:TextBox ID="tb_endcustomername" runat="server" MaxLength="100" Enabled="false"></asp:TextBox></li>
            <li><label>联系人：</label><asp:TextBox ID="tb_contactperson" runat="server" MaxLength="50" Enabled="false"></asp:TextBox></li>
            <li><label>电话：</label><asp:TextBox ID="tb_telephone" runat="server" MaxLength="20" Enabled="false"></asp:TextBox></li>
            <li><label>手机：</label><asp:TextBox ID="tb_mobile" runat="server" MaxLength="20" Enabled="false"></asp:TextBox></li>
            <li><label>地址：</label><asp:TextBox ID="tb_address" runat="server" MaxLength="100" Enabled="false"></asp:TextBox></li>
            <li class="margin-bottom"><label>邮编：</label><asp:TextBox ID="tb_postcode" runat="server" MaxLength="10" Enabled="false"></asp:TextBox></li>
            ...
            <li><label>跟单技术员：</label><asp:DropDownList ID="ddl_technician" AutoPostBack="true" OnSelectedIndexChanged="ddl_technician_changed" runat="server"></asp:DropDownList>
            <asp:HiddenField ID="hf_technicianid" Value="" runat="server" /></li>
