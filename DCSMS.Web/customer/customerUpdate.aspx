...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="main-title">
        <asp:Literal runat="server" Text="<%$ Resources:GlobalResource, customer_update %>"></asp:Literal>
    </div>

    <div class="main-content">
        <div class="content-list"><ul>
            <li><label><asp:Literal runat="server" Text="<%$ Resources:GlobalResource, customer_id %>"></asp:Literal>：</label><asp:Label ID="lb_customerid" runat="server"></asp:Label></li>
            <li><label><asp:Literal runat="server" Text="<%$ Resources:GlobalResource, customer_name %>"></asp:Literal>：</label><asp:TextBox ID="tb_customername" runat="server" MaxLength="100"></asp:TextBox></li>
            <li><label><asp:Literal runat="server" Text="<%$ Resources:GlobalResource, end_customer_name %>"></asp:Literal>：</label><asp:TextBox ID="tb_endcustomername" runat="server" MaxLength="100"></asp:TextBox></li>
            <li><label><asp:Literal runat="server" Text="<%$ Resources:GlobalResource, contact_person %>"></asp:Literal>：</label><asp:TextBox ID="tb_contactperson" runat="server" MaxLength="50"></asp:TextBox></li>
